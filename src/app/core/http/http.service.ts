...
export class HttpService extends HttpClient {
  ...
  get(url: any, options?: any): Observable<any> {
    return this.request( 'Get', url, Object.assign({}, options ));
  }

  post(url: any, body: any, options?: any): Observable<any> {
    return this.request( 'Post', url, Object.assign({}, options, { body: body }));
  }

  put(url: any, body: any, options?: any): Observable<any> {
    return this.request( 'Put', url, Object.assign({}, options, {  body: body }));
  }
